...
class CustomMediaController : FrameLayout {
    ...
    private val mRewListener = OnClickListener {
        ...
        var pos = mPlayer?.getCurrentPosition()?:0
    ...
    private fun initControllerView(v: View) {
        ...
        mFfwdButton = v.findViewById(R.id.fwd)
    ...
    private fun setProgress(): Int {
        ...
        val position = mPlayer?.getCurrentPosition()?:0
        val duration = mPlayer?.getDuration()?:0
    ...
    override fun onInitializeAccessibilityEvent(event: AccessibilityEvent) {
        ...
        event.className = CustomMediaController::class.java.name
    }

    override fun onInitializeAccessibilityNodeInfo(info: AccessibilityNodeInfo) {
        super.onInitializeAccessibilityNodeInfo(info)
        info.className = CustomMediaController::class.java.name
    }
    ...
    private class MessageHandler internal constructor(view: CustomMediaController) : Handler() {
        private val mView: WeakReference<CustomMediaController>
